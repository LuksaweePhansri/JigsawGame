<?php
namespace luksaweeP\hw4\src\models;
...
class Model {
  ...
  function uploadImgToServer() {
    ...
    if ($uploadOk == 0) {
      return "Sorry, your file cannot uploaded.";
